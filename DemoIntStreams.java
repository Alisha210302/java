...
import java.util.OptionalDouble; // Import OptionalDouble for handling double values
import java.util.OptionalInt; // Import OptionalInt for handling int values
...
public class DemoIntStreams {
    ...
    public static void main(String[] args) {
        ...
        // Count the total number of elements in the stream and print it
        ...
        // Reinitialize the stream to print distinct sorted elements
        stream = Arrays.stream(nums);
        // The following line has a typo ("discount" should be "distinct")
